...
if TYPE_CHECKING:
  from ..models.checkpoint_report_checkpoint_cycle_failures_item import CheckpointReportCheckpointCycleFailuresItem
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _checkpoint_cycle_failures is not UNSET:
            ...
            for checkpoint_cycle_failures_item_data in _checkpoint_cycle_failures:
                checkpoint_cycle_failures_item = CheckpointReportCheckpointCycleFailuresItem.from_dict(checkpoint_cycle_failures_item_data)
