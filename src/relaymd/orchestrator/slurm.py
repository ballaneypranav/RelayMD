...
def _render_sbatch_script(
    ...
    *,
    ...
    worker_image_source = cluster.worker_image_source(worker_image_key)
    ...
    return template.render(
        ...
        worker_heartbeat_failure_grace_floor_seconds=(
            settings.worker_heartbeat_failure_grace_floor_seconds
        ),
